package website.xihan.signhelper.model
...
interface ApkSignatureDao : BaseDao<ApkSignature> {
     ...
     * 根据包名更新 isRedirect
     */
    @Query("UPDATE ApkSignature SET isRedirect = :isRedirect WHERE packageName = :packageName")
    ...
    /**
     * 根据包名 更新 redirectPath
     */
    @Query("UPDATE ApkSignature SET redirectPath = :redirectPath WHERE packageName = :packageName")
    suspend fun updateRedirectPath(packageName: String, redirectPath: String)
